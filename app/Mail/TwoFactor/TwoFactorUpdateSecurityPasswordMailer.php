...
class TwoFactorUpdateSecurityPasswordMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - 2-Step Verification - Reset Master Password';
    const HEADER = 'Oriental Wallet - 2-Step Verification - Reset Master Password';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message = "<div>"._lang("To complete the master password reset, please enter the following verification code.")."</div><br/>";
