...
class TwoFactorCardTopUpMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - 2-Step Verification - Card Top-up';
    const HEADER = '';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message = "<div>"._lang("To complete your card top-up request, please enter the following verification code.")."</div><br/>";
