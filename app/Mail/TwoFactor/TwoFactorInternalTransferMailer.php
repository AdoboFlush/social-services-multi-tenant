...
class TwoFactorInternalTransferMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - 2-Step Verification - Internal Transfer';
    const HEADER = '';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message = "<div>"._lang("To complete your Internal Transfer Request, please enter the following verification code.")."</div><br/>";
