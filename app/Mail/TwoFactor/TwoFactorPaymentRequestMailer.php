...
class TwoFactorPaymentRequestMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - 2-Step Verification - Payment Request';
    const HEADER = '';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message = "<div>"._lang("To complete your Payment Request, please enter the following verification code.")."</div><br/>";
