...
class PasswordRequestedMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - 2-Step Verification - Change Password';
    const HEADER = '';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message .= '<div>'. _lang('To complete the change of your password, please enter the following verification code.') . '</div><br/>';
