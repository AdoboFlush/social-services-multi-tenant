...
class BusinessAccountVerifiedMailer extends BaseMailer
{
    ...
    public function __construct($data)
    {
        ...
        $this->message .= "<div>". _lang("Your account has been verified and upgraded. Your withdrawal/remittance limit of EUR 2,000 has been lifted. You may now withdraw funds using our money-out services up to EUR 300,000 (or amount equivalent to other supported currencies), and unlimited internal transfers.")."</div><br/>";
