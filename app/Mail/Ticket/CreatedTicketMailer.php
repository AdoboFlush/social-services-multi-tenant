...
class CreatedTicketMailer extends BaseMailer
{
    const SUBJECT = '';
    const HEADER = '';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message = "<div>"._lang("Thank you for reaching out to Oriental Wallet support.")."</div><br/>";
        $this->message .= "<div>"._lang("Your ticket has been created.")."</div><br/>";
