...
class ManualDepositCompletedMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - Deposit Notification';
    const HEADER = 'Oriental Wallet - Deposit Notification';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message = "<div>"._lang("The funds have been successfully deposited to your Oriental Wallet account.")."<br/></div>";
