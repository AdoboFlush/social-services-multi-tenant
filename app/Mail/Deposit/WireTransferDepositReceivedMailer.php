...
class WireTransferDepositReceivedMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - Deposit Completed via Wire Transfer';
    const HEADER = 'Oriental Wallet - Deposit Completed via Wire Transfer';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message .= $data->message ? "<tr><td>"._lang("Message")."</td><td>{$data->message}</td></tr>" : "";
