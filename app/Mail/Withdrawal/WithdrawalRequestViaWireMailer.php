...
class WithdrawalRequestViaWireMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - Processing of Withdrawal Application via Wire Transfer';
    const HEADER = 'Oriental Wallet - Processing of Withdrawal Application via Wire Transfer';
    const LINK_TEXT = '';
