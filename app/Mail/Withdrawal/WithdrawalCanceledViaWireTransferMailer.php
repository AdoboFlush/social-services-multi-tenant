...
class WithdrawalCanceledViaWireTransferMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - Cancellation of Withdrawal Application via Wire Transfer';
    const HEADER = 'Oriental Wallet - Cancellation of Withdrawal Application via Wire Transfer';
    const LINK_TEXT = '';
