...
class WithdrawalCanceledMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - Cancellation of Withdrawal Application via Local Bank Transfer (Japan)';
    const HEADER = 'Oriental Wallet - Cancellation of Withdrawal Application via Local Bank Transfer (Japan)';
    const LINK_TEXT = '';
