...
class CorporateBulkWithdrawalMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - Withdrawal Completion Notice via Local Bank Transfer (Japan)';
    const HEADER = 'Oriental Wallet - Withdrawal Completion Notice via Local Bank Transfer (Japan)';
    const LINK_TEXT = '';
