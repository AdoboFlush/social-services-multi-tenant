...
class ManualWithdrawalCompletedMailer extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - Withdrawal Notification';
    const HEADER = 'Oriental Wallet - Withdrawal Notification';
    const LINK_TEXT = '';
