...
class WithdrawalCompleteViaSEA extends BaseMailer
{
    const SUBJECT = 'Oriental Wallet - Withdrawal Completion Notice via Local Bank Transfer (SEA)';
    const HEADER = 'Oriental Wallet - Withdrawal Completion Notice via Local Bank Transfer (SEA)';
    const LINK_TEXT = '';
    ...
    public function __construct($data)
    {
        ...
        $this->message .= "<table>
            ...
            <tr><td>" . _lang("Beneficiary Amount") ."</td><td>{$data->currency} {$amount}</td></tr>
            ...
            <tr><td>" . _lang("Message") ."</td><td>Withdrawal via LBT (SEA)</td></tr>
