...
class AccountTypeController extends Controller
{
    ...
    {	
	    ...
	    $accounttype->account_type = $request->input('account_type');
		$accounttype->currency_id = $request->input('currency_id');
		$accounttype->maintenance_fee = $request->input('maintenance_fee');
		$accounttype->interest_rate = $request->input('interest_rate');
		$accounttype->interest_period = $request->input('interest_period');
		$accounttype->payout_period = $request->input('payout_period');
		$accounttype->auto_create = $request->input('auto_create');
    ...
    public function destroy($id)
    {
        $accounttype = AccountType::find($id);
        $accounttype->delete();
        return redirect()->route('account_types.index')->with('success',_lang('Deleted Successfully'));
    }
}
