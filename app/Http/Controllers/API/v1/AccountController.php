...
use App\Services\Account\AccountFacade;
...
class AccountController extends Controller
{
     ...
     * @return void
     */
    public function __construct(AccountFacade $account)
    {
    ...
    {       
        return $this->account::getMerchantViaSignature($request);
    }

    public function dormancy(int $user_id = 0)
    {       
        return $this->account::dormancy($user_id);
    }

    public function maintenance(int $user_id = 0)
    {       
        return $this->account::maintenance($user_id);
    }
