...
class AuthController extends Controller
{
	...
	*/
	public function login(Request $request)
	{
		...
		if (Setting::where('name','isMaintenance')->first()->value !== Setting::MAINTENANCE_ACTIVE) {
			$this->userService->addUserSession($request, $user->id, UserSession::METHOD_API);
		}
	...
	*/
    ...
    {	
		...
		$userinformation->language = $request->input('language');
		...
		$data['result']  = true;
		$data['message'] = _lang('Profile updated successfully');
        $data['data']	 = $profile;
	...
	public function update_profile_picture(Request $request){
		...
		$data['result']  = true;
		$data['message'] = _lang('Profile picture updated successfully');
        $data['data']	 = $profile;
	...
	public function update_password(Request $request)
    {
		...
		return response()->json(['result' => true, 'message' => _lang('Password updated successfully')]);
    }
