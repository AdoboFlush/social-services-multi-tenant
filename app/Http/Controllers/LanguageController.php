...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
		...
		return redirect('admin/languages')->with('success',_lang('Language Created Successfully'));
    ...
    public function update(Request $request, $id)
    {
        ...
        activity("Language")
            ->causedBy(Auth::user())
            ->log('updated '. $id .' language');

		if(fwrite($file, $contents)){
		   return redirect('admin/languages')->with('success',_lang('Updated Successfully'));
		}else{
    ...
    public function destroy($id)
    {
        if(file_exists(resource_path() . "/language/$id.php")){
			...
			return redirect('admin/languages')->with('success',_lang('Removed Successfully'));
		}
    }
}
