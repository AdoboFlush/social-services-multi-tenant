                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="ml-auto">
                                <a href="{{ route('paymaster.voter_assistance.events.index', [], false) }}" class="btn btn-warning btn-sm">
                                    <i class="fa fa-arrow-left mr-1"></i>{{ _lang('Back to Events') }}
                                </a>
                            </div>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">--</label>
                                <button class="btn btn-warning btn-sm form-control" id="btn-scan-qr" type="button"><i class="fa fa-camera mr-2"></i>Claim via QR</button>
                            </div>
                        </div>
