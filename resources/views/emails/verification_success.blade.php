...
<body>
<head>
    <title>Oriental Wallet Email</title>
    ...
    <tr>
        <td align="center" valign="top" class="email-container">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="600">
                ...
                <tr>
                    <td>
                        ...
                        @if (isset($user->new_email))
                            <p>
                                {{ _lang('You have successfully verified your new email.') }}
                            </p>
                        @else
                            <p>
                                {{ _lang('You have successfully verified your account') }}
                            </p>
                        @endif
                    </td>
                </tr>
                <tr>
                    <td>
                        {{ _lang('Please click the link below to login.') }} <br />
                        <a href="{{ url('login') }}" class="btn btn-email">{{ _lang('Login') }}</a>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <hr style="color:gray" />
                        <h4>Oriental Wallet Customer Support</h4>
