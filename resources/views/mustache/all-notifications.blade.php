<script id="mustache-table" type="text/x-handlebars-template">
	...
	<table class="table table-striped">
		...
		{{#each items}}
		<tr>
			<td class="text-wrap">{{this.created_at}}</td>
			<td class="text-wrap">{{this.published_at}}</td>
			<td>{{this.language}}</td>
			<td class="text-wrap">{{this.title}}</td>
			<td class="text-wrap">{{{this.content}}}</td>
			...
			<td>
				<div class="dropdown">
                    ...
                    <form action="/admin/notification/{{ this.id }}" method="post">
						<input name="_method" type="hidden" value="DELETE">
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">                   
                            <a href="/admin/notification/edit/{{ this.id }}" class="dropdown-item"><i class="mdi mdi-pencil"></i> Edit</a>
