<script id="mustache-table" type="text/x-handlebars-template">
	...
	<table class="table table-striped">
        ...
        <tr>
            <td class="text-wrap">
                <a href="/admin/ticket/show/{{this.id}}">{{this.id}}</a>
            </td>
            <td class="text-wrap">{{hStrReplace this.subject "_" " "}}</td>
            <td class="text-wrap">
                <a href="/admin/users/edit/{{ this.user.account_number}}" target="_blank" data-user_id="{{ this.user.id }}" onclick="logViewUser(this)">{{this.user.account_number }} {{this.user.first_name}} {{this.user.last_name }}</a>
            </td>
            ...
            <td class="text-wrap">{{hStrReplace this.department "_" " "}}</td>
            <td class="text-wrap">{{this.operator.first_name}} {{this.operator.last_name}}</td>
            <td>{{this.priority}}</td>
            <td>{{hStrReplace this.tag "_" " "}}</td>
            <td>{{this.status}}</td>
        </tr>
        {{/each}}
    </table>
