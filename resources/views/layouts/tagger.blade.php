...
<head>
  ...
  <title>{{ env('APP_NAME') }} | Voter Tagging System</title>
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
              ...
              <a href="/voters/tagging" class="dropdown-item">
                  <i class="fa fa-tags mr-2"></i> Voter Tagging
                </a>
              @if (auth()->user()->hasActivityLogAccess())
                <a href="/voters/tagging/activity_log" class="dropdown-item">
                  <i class="fa fa-file mr-2"></i> Activity Logs
                </a>
              @endif   
