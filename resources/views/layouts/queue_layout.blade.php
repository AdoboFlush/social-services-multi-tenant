...
<head>
  ...
  <title>{{ env('APP_NAME') }} | Queueing System</title>
...
<body class="hold-transition layout-top-nav">
  ...
  <div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <span class="dropdown-item">
                    <i class="fa fa-user mr-2"></i> {{auth()->user()->email}}
                </span>
    ...
    <div class="header-title-section d-flex justify-content-between align-items-center my-4" style="width: 100%;">
      <img src="{{ asset('images/juan-connect-logo-black.png') }}" alt="Left Logo" class="img-fluid" style="max-width: 200px; height: auto; margin-left: 30px;">
    </div>
  ...
  <script type="text/javascript">  
    ...
    // --- Fullscreen nav disable ---
    $(function() {
      function toggleNavDisabled() {
        if (document.fullscreenElement) {
          $('.main-header').addClass('nav-disabled');
        } else {
          $('.main-header').removeClass('nav-disabled');
        }
      }
      // When fullscreen button is clicked
      $(document).on('click', '[data-widget="fullscreen"]', function() {
        setTimeout(toggleNavDisabled, 100);
      });

      // Listen for fullscreen changes (ESC, etc)
      document.addEventListener('fullscreenchange', toggleNavDisabled);
    });
  </script>
