	...
	<div class="row">
		...
		<div class="card-body">
			...
			<table class="table">
				...
				<tr><td>{{ _lang('Account Status') }}</td><td>{!! $user->account_status == 'Verified' ? status(_lang('Verified'),'success') : status(_lang($user->account_status ? $user->account_status : "Unverified"),'danger') !!}</td></tr>
