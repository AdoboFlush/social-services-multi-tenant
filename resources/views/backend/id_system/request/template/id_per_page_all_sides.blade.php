...
<div class="paper-area" data-file-name="{{$file_name}}" data-last-page={{$last_page}}>
    @foreach($id_requests as $id_request)
        ...
        <div class="card-area" data-file-name="{{$data->name_on_id}}-front.png" data-part="front" id="id-canvass-{{$data->id}}-front" data-id="{{$data->id}}">
            <div id="id-markup-{{$data->id}}-front">
        ...
        <div class="card-area" data-file-name="{{$data->name_on_id}}-back.png" id="id-canvass-{{$data->id}}-back" data-part="back" data-id="{{$data->id}}">
            <div id="id-markup-{{$data->id}}-back">
                <img class="id_background" src="{{ !empty($back_bg) ? asset('uploads/templates/'.$back_bg) : asset('images/id_canvass.png') }}" alt="img">
