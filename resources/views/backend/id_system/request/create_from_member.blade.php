                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="member_id" id="member_id" required>
                            <option value="{{$selected_member->id}}" data-full-name="{{$selected_member->full_name}}" {{ $selected_member->id == $selected_id ? 'selected' : '' }}>{{$selected_member->account_number." - ".$selected_member->full_name}}</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name_on_id" id="name_on_id" value="{{ $selected_member->full_name }}" required>
