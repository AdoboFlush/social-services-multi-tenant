<form method="post" class="validate" style="width:100%;" autocomplete="off" action="{{ route('poll.watchers.store', [], false) }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="precinct" id="precinct" value="{{ old('precinct') }}">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="poll_place" value="{{ old('poll_place') }}">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="clustered_precincts" value="{{ old('clustered_precincts') }}">
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="no_of_registered_voters" value="{{ old('no_of_registered_voters') }}">
            </div>
        </div>
    </div>
