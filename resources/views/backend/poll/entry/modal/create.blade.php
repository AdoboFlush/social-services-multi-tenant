<form method="post" class="validate" style="width:100%;" autocomplete="off" action="{{ route('poll.entries.store', [], false) }}">
    {{ csrf_field() }}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control watcher-search-ajax" name="poll_election_watcher_id" required disabled>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <select class="form-control candidate-search-ajax" name="poll_election_candidate_id" required disabled>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="votes" min="0" required>
            </div>
        </div>
...
<script>
    $(function() {
        ...
        $(".watcher-search-ajax").select2({
            ...
            dropdownParent: $('#main_modal'),
            ajax: {
                url: () => "{{ route('poll.elections.filtered.watchers', ':id', false) }}".replace(':id', $(".election-search-ajax").val()),
                dataType: 'json',
                delay: 250,
                data: params => ({ q: params.term }),
                processResults: data => ({
        ...
        $(".candidate-search-ajax").select2({
            ...
            dropdownParent: $('#main_modal'),
            ajax: {
                url: () => "{{ route('poll.elections.filtered.candidates', ':id', false) }}".replace(':id', $(".election-search-ajax").val()),
                dataType: 'json',
                delay: 250,
                data: params => ({ q: params.term }),
                processResults: data => ({
