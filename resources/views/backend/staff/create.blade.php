...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">{{ _lang('Create Staff') }}</h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="/">Home</a></li>
					<li class="breadcrumb-item"><a href="/">Staffs</a></li>
					<li class="breadcrumb-item active">{{ _lang('Create Staff') }}</li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
...
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					<form method="post" class="validate" autocomplete="off" action="{{ route('staffs.store', [], false) }}" enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-6">
								{{ csrf_field() }}
								<div class="col-md-12">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<select class="form-control select2" id="user-type" name="user_access" required>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<span class="mr-5"><input type="checkbox" name="has_area_search" /> <b> [FOR TAGGER] Has Area Search </b></span>
