        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Add New Social Service Assistance Request (Member)</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <form method="post" style="width:100%;" autocomplete="off" action="{{ url('social_service/store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" value="{{ $member->is_voter }}" name="is_voter" />
                        ...
                        <div class="row" id="voter-container">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="precinct" id="precinct" value="{{ $member->precinct }}" readonly>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="last_name" id="last_name" value="{{ $member->last_name }}" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="first_name" value="{{ $member->first_name }}" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="middle_name" id="middle_name" value="{{ $member->middle_name }}" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="suffix" id="suffix" value="{{ $member->suffix }}" readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker" name="birth_date" id="birth_date" value="{{ $member->birth_date }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control telephone" name="contact_number" id="contact_number" value="{{ !empty($member->contact_number) ? $member->contact_number : '+63'}}" readonly>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="brgy" id="brgy" value="{{ $member->brgy }}" readonly>
