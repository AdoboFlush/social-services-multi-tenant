        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Add New Social Service Assistance Request (Voter)</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    ...
                    <form method="post" style="width:100%;" autocomplete="off" action="{{ url('social_service/store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" value="1" name="is_voter" />
                        <input type="hidden" value="{{ $voter->id }}" name="voter_id" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="request_type_id" id="request_type_id" {{ $event ? 'readonly' : '' }} required>
                                        <option value="">Please select Request type</option>
                                        @foreach($purposes as $purpose)
                                        <option value="{{$purpose->id}}" {{ $event ? $event->request_type_id === $purpose->id ? 'selected' : '' : '' }}>{{$purpose->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="purpose[]" id="purpose" multiple="multiple" {{ !$event ? 'disabled' : '' }} required>
                        ...
                        <div class="row" id="voter-container">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="precinct" id="precinct" value="{{ $voter->precinct }}" readonly>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="last_name" id="last_name" value="{{ $voter->last_name }}" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="first_name" id="first_name" value="{{ $voter->first_name }}" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="middle_name" id="middle_name" value="{{ $voter->middle_name }}" readonly>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="suffix" id="suffix" value="{{ $voter->suffix }}" readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control datepicker" name="birth_date" id="birth_date" value="{{ $voter->birth_date }}" readonly>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Contact Number') }} ( <i>Note: This will also update the Voter record if changed.</i> )</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="brgy" id="brgy" value="{{ $voter->brgy }}" readonly>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="address" id="address" value="{{ $voter->address }}" readonly>
                        ...
                        <div class="mb-3"><span class="font-weight-bold">Requestor Information</span> <span><input type="checkbox" name="same_with_beneficiary" id="same_with_beneficiary" class="ml-5 mr-1"/>Same with the beneficiary?</span></div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Last Name') }}</label>
...
<script>
// Inject PHP variables as JS variables
var hasEvent = {{ $event ? 'true' : 'false' }};
var eventRequestTypeId = @json($event ? $event->request_type_id : null);
var eventPurposes = @json($event && isset($event->purposes) ? $event->purposes : []);
...
$(document).ready(function(){
    ...
    // If $event is set, load purposes on page load
    if(hasEvent && eventRequestTypeId) {
        $('#purpose').html('<option value="">Loading Options... </option>');
        $('#purpose').attr('disabled', true);
        $.get("{{url('tag/get_child_tags')}}/" + eventRequestTypeId, function(data, status){
            if(status == 'success'){
                $('#purpose').html('<option value="">Please select a purpose</option>');
                $.each(data, function(key, value){
                    let selected = eventPurposes.includes(value.name) ? 'selected' : '';
                    $('#purpose').append('<option value="'+value.name+'" '+selected+'>'+value.name+'</option>');
                });
                $('#purpose').attr('disabled', false);
                $('#purpose').select2();
            }
