						...
						<div id="deposit" class="tab-pane active">
							<div class="card">
								<div class="card-body">
									...
									<form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{ url('admin/administration/settings/message_template') }}" enctype="multipart/form-data">
										{{ csrf_field() }}
										<div class="row">
										    <div class="col-md-12">
