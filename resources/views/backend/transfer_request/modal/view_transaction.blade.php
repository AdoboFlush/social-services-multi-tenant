...
@if($transaction->status == 'pending')
	<div class="row mb-3">
		<div class="col-md-12">
			<a class="btn btn-success btn-sm" href="{{ url('admin/transfer/action/' . $transaction->id . '/approve') }}"><i class="far fa-check-square"></i>&nbsp;{{ _lang('Mark as Approve') }}</a>

			<a class="btn btn-danger btn-sm float-right" href="{{ url('admin/transfer/action/' . $transaction->id . '/reject') }}"><i class="far fa-times-circle"></i>&nbsp;{{ _lang('Mark as Reject') }}</a>
		</div>
	</div>	
@endif
